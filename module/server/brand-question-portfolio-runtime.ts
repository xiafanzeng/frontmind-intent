...
} from "../contracts/brand-question-portfolio.js";
import type { ManagedAgentProfile } from "../contracts/manus-agent-profile.js";
import {
  buildDeterministicTaskAttachmentArchive,
  buildDirectorySkillArchive,
} from "@frontmind/module-contracts/task-attachment-package";
import { assertUpstreamPromptBudget } from "@frontmind/module-contracts/upstream-prompt-budget";
...
const skillDirectoryCandidates = configuredBrandQuestionSkillPath ? [configuredBrandQuestionSkillPath] : [path.resolve(import.meta.dirname, "../workflows/brand-question-portfolio.skill"), path.resolve(process.cwd(), "modules/intent/workflows/brand-question-portfolio.skill"), path.resolve(process.cwd(), "private-workflows/brand-question-portfolio.skill")];
